...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MaxPlayerId")));
bytes32 constant MaxPlayerIdTableId = _tableId;
...
library MaxPlayerId {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MaxPlayerId", _fieldNames);
  }
