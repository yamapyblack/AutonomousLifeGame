...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CalculatedCount")));
bytes32 constant CalculatedCountTableId = _tableId;

library CalculatedCount {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CalculatedCount", _fieldNames);
  }
