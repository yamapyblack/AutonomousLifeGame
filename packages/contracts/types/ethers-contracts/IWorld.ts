...
export interface IWorldInterface extends utils.Interface {
  functions: {
    "add(uint32,uint32,uint8)": FunctionFragment;
    "calculate()": FunctionFragment;
    ...
    "getCellPower(uint8)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "calculate", values?: undefined): string;
  encodeFunctionData(
...
export interface IWorld extends BaseContract {
  ...
  functions: {
    ...
    getCellPower(
      playerId_: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[number] & { cellPower_: number }>;
  ...
  callStatic: {
    ...
    calculate(overrides?: CallOverrides): Promise<void>;
    ...
    join(overrides?: CallOverrides): Promise<number>;
